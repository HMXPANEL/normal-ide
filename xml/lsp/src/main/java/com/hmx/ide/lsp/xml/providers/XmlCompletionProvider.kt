...
package com.hmx.ide.lsp.xml.providers
...
import com.hmx.ide.lsp.api.AbstractServiceProvider
...
import com.hmx.ide.lsp.models.CompletionResult.Companion.EMPTY
import com.hmx.ide.lsp.xml.providers.completion.AttrValueCompletionProvider
import com.hmx.ide.lsp.xml.providers.completion.IXmlCompletionProvider
import com.hmx.ide.lsp.xml.providers.completion.canCompleteManifest
import com.hmx.ide.lsp.xml.providers.completion.common.CommonAttrCompletionProvider
import com.hmx.ide.lsp.xml.providers.completion.etc.InheritingAttrCompletionProvider
import com.hmx.ide.lsp.xml.providers.completion.layout.LayoutAttrCompletionProvider
import com.hmx.ide.lsp.xml.providers.completion.layout.LayoutTagCompletionProvider
import com.hmx.ide.lsp.xml.providers.completion.manifest.ManifestAttrCompletionProvider
import com.hmx.ide.lsp.xml.providers.completion.manifest.ManifestAttrValueCompletionProvider
import com.hmx.ide.lsp.xml.providers.completion.manifest.ManifestTagCompletionProvider
import com.hmx.ide.lsp.xml.utils.AnimTagTransformer
import com.hmx.ide.lsp.xml.utils.AnimatorTagTransformer
import com.hmx.ide.lsp.xml.utils.DrawableTagTransformer
import com.hmx.ide.lsp.xml.utils.ITagTransformer
import com.hmx.ide.lsp.xml.utils.MenuTagTransformer
import com.hmx.ide.lsp.xml.utils.NoOpTagTransformer
import com.hmx.ide.lsp.xml.utils.TransitionTagTransformer
import com.hmx.ide.lsp.xml.utils.XmlUtils
import com.hmx.ide.lsp.xml.utils.XmlUtils.NodeType
import com.hmx.ide.lsp.xml.utils.XmlUtils.NodeType.ATTRIBUTE
import com.hmx.ide.lsp.xml.utils.XmlUtils.NodeType.ATTRIBUTE_VALUE
import com.hmx.ide.lsp.xml.utils.XmlUtils.NodeType.TAG
import com.hmx.ide.lsp.xml.utils.XmlUtils.NodeType.UNKNOWN
import com.hmx.ide.lsp.xml.utils.forTransitionAttr
import com.hmx.ide.utils.CharSequenceReader
