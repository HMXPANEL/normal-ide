...
package com.hmx.ide.tooling.api.models.result

/**
 * Result sent to the client when selecting a project in [IProjectQueries][com.hmx.ide.tooling.api.IProjectQueries].
 *
