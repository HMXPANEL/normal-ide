...
package com.hmx.ide.gradle

import com.hmx.ide.buildinfo.BuildInfo
import com.hmx.ide.tooling.api.LogSenderConfig._PROPERTY_IS_TEST_ENV
import com.hmx.ide.tooling.api.LogSenderConfig._PROPERTY_MAVEN_LOCAL_REPOSITORY
...
internal fun writeInitScript(file: File, deps: List<File>) {
  ...
  file.bufferedWriter().use {
    it.write(
      ...
      apply plugin: com.hmx.ide.gradle.AndroidIDEInitScriptPlugin
    """.trimIndent()
    )
  }
}
