...
import com.hmx.ide.builder.model.IDESyncIssue
...
import com.hmx.ide.utils.AndroidPluginVersion.Companion.MINIMUM_SUPPORTED
import com.hmx.ide.utils.ILogger
import com.hmx.ide.utils.LogUtils
...
abstract class AbstractModelBuilder<P, R>(
  ...
  companion object {
     ...
     * [ generateMessage(Object...)][com.hmx.ide.utils.ILogger.generateMessage] in [ILogger][com.hmx.ide.utils.ILogger].
     *
