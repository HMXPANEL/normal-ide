...
import com.hmx.ide.tooling.api.messages.GradleDistributionType
...
import com.hmx.ide.tooling.impl.sync.ModelBuilderException
import com.hmx.ide.tooling.impl.sync.RootModelBuilder
import com.hmx.ide.tooling.impl.sync.RootProjectModelBuilderParams
...
internal class ToolingApiServerImpl(private val project: ProjectImpl) :
  ...
  override fun shutdown(): CompletableFuture<Void> {
    return CompletableFuture.supplyAsync {
      ...
      // see com.hmx.ide.tooling.impl.Main.main(String[])
