...
import com.hmx.ide.tooling.impl.Main
import com.hmx.ide.tooling.impl.Main.finalizeLauncher
import com.hmx.ide.tooling.impl.internal.ProjectImpl
...
class RootModelBuilder(initializationParams: InitializeProjectParams) :
  ...
  override fun build(param: RootProjectModelBuilderParams): IProject {
    ...
    logger.warn("Starting sync. See sync output for more details...")
