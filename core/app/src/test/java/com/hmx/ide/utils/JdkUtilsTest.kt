...
class JdkUtilsTest {
  ...
  companion object {
    ...
    java.home = /data/data/com.hmx.ide/files/usr/opt/openjdk-17.0
    java.io.tmpdir = /data/data/com.hmx.ide/files/usr/tmp/
    java.library.path = /data/data/com.hmx.ide/files/usr/java/packages/lib
        /data/data/com.hmx.ide/files/usr/lib
    ...
    sun.boot.library.path = /data/data/com.hmx.ide/files/usr/opt/openjdk-17.0/lib
    ...
    user.dir = /data/data/com.hmx.ide/files/home
    user.home = /data/data/com.hmx.ide/files/home
    user.language = en
    user.name = u0_a248
...
OpenJDK 64-Bit Server VM (build 17-internal+0-adhoc.root.src, mixed mode)
    ...
    java.home = /data/data/com.hmx.ide/files/usr/opt/openjdk-21.0.1
    java.io.tmpdir = /data/data/com.hmx.ide/files/usr/tmp/
    java.library.path = /data/data/com.hmx.ide/files/usr/java/packages/lib
        /data/data/com.hmx.ide/files/usr/lib
    java.runtime.name = OpenJDK Runtime Environment
    ...
    sun.arch.data.model = 64
    sun.boot.library.path = /data/data/com.hmx.ide/files/usr/opt/openjdk-21.0.1/lib
    sun.cpu.endian = little
    sun.io.unicode.encoding = UnicodeLittle
    sun.java.launcher = SUN_STANDARD
    sun.jnu.encoding = UTF-8
...
OpenJDK 64-Bit Server VM (build 21.0.1-internal-adhoc.root.src, mixed mode)
  ...
  fun `test parsing java home for JDK 17`() {
    ...
    assertThat(dist.javaHome).isEqualTo(
      "/data/data/com.hmx.ide/files/usr/opt/openjdk-17.0"
    )
  }
  ...
  fun `test parsing java home for JDK 21`() {
    ...
    assertThat(dist.javaHome).isEqualTo(
      "/data/data/com.hmx.ide/files/usr/opt/openjdk-21.0.1"
    )
  }
