...
package com.hmx.ide.services.builder
...
import com.hmx.ide.services.ToolingServerNotStartedException
import com.hmx.ide.services.builder.ToolingServerRunner.OnServerStartListener
import com.hmx.ide.tasks.ifCancelledOrInterrupted
import com.hmx.ide.tooling.api.ForwardingToolingApiClient
...
import com.hmx.ide.tooling.api.LogSenderConfig.PROPERTY_LOGSENDER_ENABLED
...
import com.hmx.ide.utils.IdeShellEnvironment
...
class GradleBuildService : Service(), BuildService, IToolingApiClient,
  ...
  override fun logMessage(params: com.hmx.ide.tooling.api.messages.LogMessageParams) {
  ...
  override fun getBuildArguments(): CompletableFuture<List<String>> {
    ...
    extraArgs.add("-P${PROPERTY_LOGSENDER_ENABLED}=${com.hmx.ide.preferences.internal.DevOpsPreferences.logsenderEnabled}")
