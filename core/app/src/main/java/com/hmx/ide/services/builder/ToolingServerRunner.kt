...
import com.hmx.ide.shell.executeProcessAsync
  ...
  fun startAsync(envs: Map<String, String>) = runnerScope.launch {
    ...
    try {
      ...
      val command = listOf(
        ...
        "-D${CoreConstants.STATUS_LISTENER_CLASS_KEY}=com.hmx.ide.tooling.impl.util.LogbackStatusListener",
      ...
      pid = IdeReflectionUtils.getDeclaredField(process::class.java, "pid")?.get(process) as Int?
