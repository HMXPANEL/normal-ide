...
package com.hmx.ide.handlers

import android.content.Context
import androidx.lifecycle.DefaultLifecycleObserver
import androidx.lifecycle.LifecycleOwner
import com.hmx.ide.eventbus.events.Event
import com.hmx.ide.eventbus.events.EventReceiver
import com.hmx.ide.eventbus.events.editor.OnCreateEvent
import com.hmx.ide.eventbus.events.editor.OnDestroyEvent
import com.hmx.ide.eventbus.events.editor.OnPauseEvent
import com.hmx.ide.eventbus.events.editor.OnResumeEvent
import com.hmx.ide.eventbus.events.editor.OnStartEvent
import com.hmx.ide.eventbus.events.editor.OnStopEvent
import com.hmx.ide.projects.internal.ProjectManagerImpl
import com.hmx.ide.projects.util.BootClasspathProvider
import com.hmx.ide.utils.EditorActivityActions
import com.hmx.ide.utils.EditorSidebarActions
import com.hmx.ide.utils.Environment
import org.greenrobot.eventbus.EventBus
import java.util.concurrent.CompletableFuture

/**
 * Observes lifecycle events if [com.hmx.ide.EditorActivityKt].
 *
 * @author Akash Yadav
 */
