...
import com.hmx.ide.actions.ActionItem.Location.EDITOR_FILE_TABS
import com.hmx.ide.adapters.DiagnosticsAdapter
import com.hmx.ide.adapters.SearchListAdapter
import com.hmx.ide.app.EdgeToEdgeIDEActivity
import com.hmx.ide.databinding.ActivityEditorBinding
import com.hmx.ide.databinding.ContentEditorBinding
import com.hmx.ide.databinding.LayoutDiagnosticInfoBinding
import com.hmx.ide.fragments.SearchResultFragment
import com.hmx.ide.fragments.sidebar.EditorSidebarFragment
import com.hmx.ide.fragments.sidebar.FileTreeFragment
import com.hmx.ide.handlers.EditorActivityLifecyclerObserver
import com.hmx.ide.handlers.LspHandler.registerLanguageServers
import com.hmx.ide.interfaces.DiagnosticClickListener
import com.hmx.ide.lookup.Lookup
import com.hmx.ide.lsp.models.DiagnosticItem
import com.hmx.ide.models.DiagnosticGroup
import com.hmx.ide.models.OpenedFile
import com.hmx.ide.models.Range
import com.hmx.ide.models.SearchResult
import com.hmx.ide.preferences.internal.BuildPreferences
import com.hmx.ide.projects.IProjectManager
import com.hmx.ide.tasks.cancelIfActive
import com.hmx.ide.ui.CodeEditorView
import com.hmx.ide.ui.ContentTranslatingDrawerLayout
import com.hmx.ide.ui.SwipeRevealLayout
import com.hmx.ide.uidesigner.UIDesignerActivity
import com.hmx.ide.utils.ActionMenuUtils.createMenu
import com.hmx.ide.utils.DialogUtils.newMaterialDialogBuilder
import com.hmx.ide.utils.IntentUtils
import com.hmx.ide.utils.MemoryUsageWatcher
import com.hmx.ide.utils.flashError
import com.hmx.ide.utils.resolveAttr
import com.hmx.ide.viewmodel.EditorViewModel
import com.hmx.ide.xml.resources.ResourceTableRegistry
import com.hmx.ide.xml.versions.ApiVersionsRegistry
...
abstract class BaseEditorActivity : EdgeToEdgeIDEActivity(), TabLayout.OnTabSelectedListener,
  ...
  private fun onBuildStatusChanged() {
    log.debug("onBuildStatusChanged: isInitializing: ${editorViewModel.isInitializing}")
    val visible = editorViewModel.isInitializing
