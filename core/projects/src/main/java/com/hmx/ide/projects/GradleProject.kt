...
/**
 * A Gradle project model which is identical to [IGradleProject][com.hmx.ide.tooling.api.IGradleProject]. This project module caches all the data
 * from an [IGradleProject][com.hmx.ide.tooling.api.IGradleProject] eliminating the use of [CompletableFuture] s.
 *
