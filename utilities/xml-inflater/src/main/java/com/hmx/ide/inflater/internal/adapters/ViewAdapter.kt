...
package com.hmx.ide.inflater.internal.adapters
...
import com.hmx.ide.annotations.inflater.ViewAdapter
import com.hmx.ide.annotations.uidesigner.IncludeInDesigner
import com.hmx.ide.annotations.uidesigner.IncludeInDesigner.Group.WIDGETS
import com.hmx.ide.inflater.AttributeHandlerScope
import com.hmx.ide.inflater.IAttribute
import com.hmx.ide.inflater.INamespace
import com.hmx.ide.inflater.IView
import com.hmx.ide.inflater.IViewAdapter
import com.hmx.ide.inflater.internal.IncludeView
import com.hmx.ide.inflater.models.UiWidget
import com.hmx.ide.inflater.utils.newAttribute
...
open class ViewAdapter<T : View> : IViewAdapter<T>() {
  ...
  protected open fun parseDrawingCacheQuality(value: String): Int {
    return com.hmx.ide.inflater.internal.utils.parseDrawingCacheQuality(value)
  }

  protected open fun parseVisibility(value: String): Int {
    return com.hmx.ide.inflater.internal.utils.parseVisibility(value)
  }

  protected open fun parseTextAlignment(value: String): Int {
    return com.hmx.ide.inflater.internal.utils.parseTextAlignment(value)
  }

  protected open fun parseTextDirection(value: String): Int {
    return com.hmx.ide.inflater.internal.utils.parseTextDirection(value)
  }

  protected open fun parsePorterDuffMode(mode: String): PorterDuff.Mode {
    return com.hmx.ide.inflater.internal.utils.parsePorterDuffMode(mode)
  }
