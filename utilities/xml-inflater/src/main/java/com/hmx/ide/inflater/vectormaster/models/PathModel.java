...
package com.hmx.ide.inflater.vectormaster.models;
...
import com.hmx.ide.inflater.vectormaster.DefaultValues;
import com.hmx.ide.inflater.vectormaster.utilities.Utils;
import com.hmx.ide.inflater.vectormaster.utilities.parser.PathParser;
...
public class PathModel {
  ...
  public void buildPath(boolean useLegacyParser) {
    if (useLegacyParser) {
      originalPath =
          com.hmx.ide.inflater.vectormaster.utilities.legacyparser.PathParser.createPathFromPathData(
              pathData);
    } else {
