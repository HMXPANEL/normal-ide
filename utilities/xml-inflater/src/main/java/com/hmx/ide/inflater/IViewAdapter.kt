 ...
 * - [ViewAdapter][com.hmx.ide.annotations.inflater.ViewAdapter] is used to specify the
 *   view whose attributes are handled by the view adapter implementation.
 * - [IncludeInDesigner][com.hmx.ide.annotations.uidesigner.IncludeInDesigner] is used to
...
abstract class IViewAdapter<T : View> : AbstractParser() {
   ...
   * [ViewAdapter][com.hmx.ide.annotations.inflater.ViewAdapter] annotation.
   *
