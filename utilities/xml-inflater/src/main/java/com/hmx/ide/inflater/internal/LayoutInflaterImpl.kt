...
package com.hmx.ide.inflater.internal
...
import com.hmx.ide.inflater.DefaultComponentFactory
import com.hmx.ide.inflater.IAttribute
import com.hmx.ide.inflater.IComponentFactory
import com.hmx.ide.inflater.IComponentFactory.Companion.LAYOUT_INFLATER_COMPONENT_FACTORY_KEY
import com.hmx.ide.inflater.ILayoutInflater
import com.hmx.ide.inflater.INamespace
import com.hmx.ide.inflater.IView
import com.hmx.ide.inflater.IViewGroup
import com.hmx.ide.inflater.InflateException
import com.hmx.ide.inflater.events.IInflateEventsListener
import com.hmx.ide.inflater.events.InflationFinishEvent
import com.hmx.ide.inflater.events.InflationStartEvent
import com.hmx.ide.inflater.events.OnApplyAttributeEvent
import com.hmx.ide.inflater.events.OnInflateViewEvent
import com.hmx.ide.inflater.internal.utils.IDTable
import com.hmx.ide.inflater.internal.utils.ViewFactory.createViewInstance
import com.hmx.ide.inflater.internal.utils.ViewFactory.generateLayoutParams
import com.hmx.ide.inflater.internal.utils.parseLayoutReference
import com.hmx.ide.inflater.utils.endParse
import com.hmx.ide.inflater.utils.isParsing
import com.hmx.ide.inflater.utils.startParse
import com.hmx.ide.inflater.viewAdapter
import com.hmx.ide.lookup.Lookup
import com.hmx.ide.projects.android.AndroidModule
import com.hmx.ide.xml.widgets.Widget
import com.hmx.ide.xml.widgets.WidgetTable
import com.hmx.ide.xml.widgets.WidgetType
import java.io.File
...
open class LayoutInflaterImpl : ILayoutInflater {
  ...
  protected open fun processXmlFile(file: File): Pair<XmlProcessor, AndroidModule> {
    return com.hmx.ide.inflater.utils.processXmlFile(file, LAYOUT)
  }
  ...
  private fun startInflation(file: File) {
    ...
    if (!isParsing) {
      if (this.module == null) {
        startParse(file)
        this.module = com.hmx.ide.inflater.utils.module
      } else {
