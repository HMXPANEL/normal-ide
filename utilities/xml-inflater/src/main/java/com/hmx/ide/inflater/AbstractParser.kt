...
import com.hmx.ide.inflater.internal.utils.defaultGravity
import com.hmx.ide.inflater.internal.utils.unknownDrawable
...
abstract class AbstractParser {
  ...
  protected open fun parseId(resName: String, value: String, def: Int = 0): Int {
    return com.hmx.ide.inflater.internal.utils.parseId(resName, value, def)
  }
  ...
  protected open fun parseFloat(value: String, def: Float = 0f): Float {
    return com.hmx.ide.inflater.internal.utils.parseFloat(value = value, def = def)
  }
  ...
  protected open fun parseLong(value: String, def: Long = 0L): Long {
    return com.hmx.ide.inflater.internal.utils.parseLong(value = value, def = def)
  }
  ...
  protected open fun parseInteger(value: String, def: Int = 0): Int {
    return com.hmx.ide.inflater.internal.utils.parseInteger(value = value, def = def)
  }
  ...
  protected open fun parseIntegerArray(value: String): IntArray {
    return com.hmx.ide.inflater.internal.utils.parseIntegerArray(value) ?: intArrayOf()
  }
  ...
  protected open fun parseBoolean(value: String, def: Boolean = false): Boolean {
    return com.hmx.ide.inflater.internal.utils.parseBoolean(value = value, def = def)
  }
  ...
  protected open fun parseString(value: String): String {
    return com.hmx.ide.inflater.internal.utils.parseString(value)
  }
  ...
  protected open fun parseStringArray(value: String): Array<String> {
    return com.hmx.ide.inflater.internal.utils.parseStringArray(value) ?: emptyArray()
  }
  ...
  protected open fun parseDrawable(
    ...
    return com.hmx.ide.inflater.internal.utils.parseDrawable(
      context = context,
      value = value,
      def = def
    )
  ...
  protected open fun parseGravity(value: String, def: Int = defaultGravity()): Int {
    return com.hmx.ide.inflater.internal.utils.parseGravity(value = value, def = def)
  }
  ...
  protected open fun parseDimensionF(context: Context, value: String, def: Float = 0f): Float {
    return com.hmx.ide.inflater.internal.utils.parseDimension(
      context = context,
      value = value,
      def = def
    )
  ...
  protected open fun parseColor(
    ...
    return com.hmx.ide.inflater.internal.utils.parseColor(
      context = context,
      value = value,
      def = def
    )
  ...
  protected open fun parseColorStateList(
    ...
    return com.hmx.ide.inflater.internal.utils.parseColorStateList(
      context = context,
      value = value,
      def = def
    )
  ...
  fun parseDate(value: String, format: String = "MM/dd/yyyy", def: Long = 0L): Long {
    return com.hmx.ide.inflater.internal.utils.parseDate(
      value = value,
      format = format,
      def = def
    )
