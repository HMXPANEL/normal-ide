...
import com.hmx.ide.templates.ParameterConstraint.CLASS
import com.hmx.ide.templates.ParameterConstraint.CLASS_NAME
import com.hmx.ide.templates.ParameterConstraint.DIRECTORY
import com.hmx.ide.templates.ParameterConstraint.EXISTS
import com.hmx.ide.templates.ParameterConstraint.FILE
import com.hmx.ide.templates.ParameterConstraint.LAYOUT
import com.hmx.ide.templates.ParameterConstraint.MODULE_NAME
import com.hmx.ide.templates.ParameterConstraint.NONEMPTY
import com.hmx.ide.templates.ParameterConstraint.PACKAGE
import com.hmx.ide.templates.base.util.isValidModuleName
import com.hmx.ide.templates.base.util.moduleNameToDirName
...
class UtilTest {
  ...
  fun `test constraint verifier`() {
    ConstraintVerifier.apply {
      ...
      assertThat(isValid("com.hmx.ide", listOf(PACKAGE))).isTrue()
