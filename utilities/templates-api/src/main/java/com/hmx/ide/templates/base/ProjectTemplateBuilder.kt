...
import com.hmx.ide.managers.ToolsManager
...
import com.hmx.ide.templates.base.root.buildGradleSrcGroovy
import com.hmx.ide.templates.base.root.buildGradleSrcKts
import com.hmx.ide.templates.base.root.gradleWrapperProps
import com.hmx.ide.templates.base.root.settingsGradleSrcStr
import com.hmx.ide.templates.base.util.optonallyKts
import com.hmx.ide.utils.transferToStream
import java.io.File
...
class ProjectTemplateBuilder :
  ...
  fun baseAsset(path: String) =
    com.hmx.ide.templates.base.util.baseAsset("root", path)
