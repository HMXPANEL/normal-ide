...
import com.hmx.ide.templates.ModuleTemplateRecipeResult
import com.hmx.ide.templates.RecipeExecutor
import com.hmx.ide.templates.SrcSet
import com.hmx.ide.templates.TemplateBuilder
import com.hmx.ide.templates.TemplateRecipeConfigurator
import com.hmx.ide.templates.TemplateRecipeFinalizer
import com.hmx.ide.templates.base.models.Dependency
import com.hmx.ide.templates.base.models.defaultDependency
...
abstract class ModuleTemplateBuilder :
   ...
   * @see com.hmx.ide.templates.base.baseAsset
   */
  open fun baseAsset(path: String) =
    com.hmx.ide.templates.base.util.baseAsset("module", path)
   ...
   * [Implementation][com.hmx.ide.templates.base.models.DependencyConfiguration.Implementation]
   * configuration.
   *
