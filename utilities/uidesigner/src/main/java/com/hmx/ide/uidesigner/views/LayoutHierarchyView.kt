...
package com.hmx.ide.uidesigner.views
...
constructor(
  ...
  private fun addViews(view: IView, depth: Int) {
    ...
    if (view is com.hmx.ide.inflater.IViewGroup) {
  ...
  private fun computeChildCount(view: com.hmx.ide.inflater.IViewGroup): Int {
    var count = view.childCount
    view.forEachIndexed { index, child ->
      if (index != view.childCount - 1 && child is com.hmx.ide.inflater.IViewGroup) {
