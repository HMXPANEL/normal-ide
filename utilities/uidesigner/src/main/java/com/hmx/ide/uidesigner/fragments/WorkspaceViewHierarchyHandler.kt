...
import com.hmx.ide.uidesigner.undo.ViewAddedAction
import com.hmx.ide.uidesigner.undo.ViewMovedAction
import com.hmx.ide.uidesigner.undo.ViewRemovedAction
...
internal class WorkspaceViewHierarchyHandler :
  ...
  private fun pushAction(view: com.hmx.ide.inflater.IView,
  ...
  override fun beforeViewAdded(group: IViewGroup,
                               view: com.hmx.ide.inflater.IView,
                               index: Int
  ) {
    animateLayoutChange()
  }
