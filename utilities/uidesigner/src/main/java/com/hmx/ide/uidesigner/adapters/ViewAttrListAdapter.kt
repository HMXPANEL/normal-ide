...
package com.hmx.ide.uidesigner.adapters
...
import com.hmx.ide.inflater.IView.SingleAttributeChangeListener
import com.hmx.ide.uidesigner.R
import com.hmx.ide.uidesigner.adapters.ViewAttrListAdapter.VH
import com.hmx.ide.uidesigner.databinding.LayoutViewattrItemBinding
...
internal class ViewAttrListAdapter(
  attributes: List<com.hmx.ide.inflater.IAttribute>,
  private val viewModel: WorkspaceViewModel?,
  private val onDeleteAttr: (com.hmx.ide.inflater.IAttribute) -> Boolean,
  private val onClick: (com.hmx.ide.inflater.IAttribute) -> Unit
