...
import com.hmx.ide.actions.EditorActionItem
import com.hmx.ide.actions.FillMenuParams
import com.hmx.ide.editor.R.layout
import com.hmx.ide.editor.databinding.LayoutPopupMenuItemBinding
import com.hmx.ide.editor.ui.EditorActionsMenu.ActionsListAdapter.VH
...
open class EditorActionsMenu(val editor: IDEEditor) :
  ...
  protected open fun onCreateActionData(): ActionData {
    ...
    data.put(com.hmx.ide.models.Range::class.java, editor.cursorLSPRange)
    data.put(
