...
import com.hmx.ide.lsp.java.indexing.classfile.JavaField
import com.hmx.ide.lsp.java.indexing.classfile.JavaMethod
...
object ModelBuilderTestUtil {
  ...
  fun createTestClass() = JavaClass.newInstance(
    fqn = "com/hmx/ide/indexing/TestClass",
    name = "TestClass",
    packageName = "com/hmx/ide/indexing",
