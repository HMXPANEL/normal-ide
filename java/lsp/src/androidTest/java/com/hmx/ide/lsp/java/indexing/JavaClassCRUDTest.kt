...
import com.hmx.ide.lsp.java.indexing.classfile.JavaClass
    ...
    dbTestRule.withDb("java-class-CRUD") {
      ...
      executeTransaction {
        ...
        dbKlass = where(JavaClass::class.java)
          .equalTo("fqn", "com/hmx/ide/indexing/TestClass")
          .findFirst()

        assertThat(dbKlass).isNotNull()
        assertThat(dbKlass?.fqn).isEqualTo("com/hmx/ide/indexing/TestClass")
        assertThat(dbKlass?.name).isEqualTo("TestClass")
        assertThat(dbKlass?.packageName).isEqualTo("com/hmx/ide/indexing")
