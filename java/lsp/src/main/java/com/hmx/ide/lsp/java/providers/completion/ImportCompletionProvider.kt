...
import com.hmx.ide.lsp.java.providers.CompletionProvider.MAX_COMPLETION_ITEMS
import com.hmx.ide.lsp.models.CompletionItem
import com.hmx.ide.lsp.models.CompletionResult
import com.hmx.ide.lsp.models.MatchLevel.CASE_SENSITIVE_EQUAL
...
import com.hmx.ide.utils.ClassTrie.Node
...
class ImportCompletionProvider(
   ...
   */
  private fun collectPackageNode(trie: com.hmx.ide.utils.ClassTrie, pkgName: String): Node? {
