...
package com.hmx.ide.lsp.java.edits
...
class MultipleClassImportEditHandler(
  ...
  override fun performEdits(
    ...
    editor: CodeEditor,
    completionItem: com.hmx.ide.lsp.models.CompletionItem
  ) {
    val edits = mutableListOf<com.hmx.ide.lsp.models.TextEdit>()
    ...
    com.hmx.ide.lsp.util.RewriteHelper.performEdits(edits, editor)
  }
}
