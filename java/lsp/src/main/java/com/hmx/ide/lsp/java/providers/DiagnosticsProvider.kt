...
import com.hmx.ide.lsp.java.models.DiagnosticCode
import com.hmx.ide.lsp.java.models.DiagnosticCode.EMPTY_BLOCK
import com.hmx.ide.lsp.java.models.DiagnosticCode.UNUSED_THROWS
import com.hmx.ide.lsp.java.visitors.DiagnosticVisitor
import com.hmx.ide.lsp.models.DiagnosticItem
import com.hmx.ide.lsp.models.DiagnosticSeverity
import com.hmx.ide.lsp.models.DiagnosticSeverity.WARNING
...
import com.hmx.ide.utils.DocumentUtils.isSameFile
...
object DiagnosticsProvider {
  ...
  private fun getPosition(position: Long, lines: LineMap): com.hmx.ide.models.Position {
    abortIfCancelled()
    ...
    return com.hmx.ide.models.Position(line, column)
  }
