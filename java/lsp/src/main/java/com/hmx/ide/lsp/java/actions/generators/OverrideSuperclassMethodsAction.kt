 ...
 */
package com.hmx.ide.lsp.java.actions.generators

import android.content.Context
import com.blankj.utilcode.util.ThreadUtils
import com.hmx.ide.actions.ActionData
import com.hmx.ide.actions.hasRequiredData
import com.hmx.ide.actions.markInvisible
import com.hmx.ide.actions.newDialogBuilder
import com.hmx.ide.actions.requireFile
import com.hmx.ide.actions.requirePath
import com.hmx.ide.lsp.java.JavaCompilerProvider
import com.hmx.ide.lsp.java.actions.BaseJavaCodeAction
import com.hmx.ide.lsp.java.compiler.CompileTask
import com.hmx.ide.lsp.java.compiler.CompilerProvider
import com.hmx.ide.lsp.java.parser.ParseTask
import com.hmx.ide.lsp.java.rewrite.AddImport
import com.hmx.ide.lsp.java.utils.EditHelper
import com.hmx.ide.lsp.java.utils.FindHelper
import com.hmx.ide.lsp.java.utils.JavaParserUtils
import com.hmx.ide.lsp.java.utils.MethodPtr
import com.hmx.ide.lsp.java.visitors.FindTypeDeclarationAt
...
class OverrideSuperclassMethodsAction : BaseJavaCodeAction() {
  ...
  override fun prepare(data: ActionData) {
    ...
    if (
      ...
      !data.hasRequiredData(
        com.hmx.ide.models.Range::class.java,
  ...
  override suspend fun execAction(data: ActionData): Any {
    val range = data[com.hmx.ide.models.Range::class.java]!!
    val compiler =
