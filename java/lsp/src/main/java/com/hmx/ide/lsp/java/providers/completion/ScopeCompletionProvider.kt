...
import com.hmx.ide.lsp.java.edits.MultipleClassImportEditHandler
import com.hmx.ide.lsp.java.models.JavaCompletionItem
import com.hmx.ide.lsp.java.utils.JavaPoetUtils.Companion.buildMethod
import com.hmx.ide.lsp.java.utils.JavaPoetUtils.Companion.print
import com.hmx.ide.lsp.java.utils.ScopeHelper
...
class ScopeCompletionProvider(
  ...
  private fun overrideIfPossible(
    ...
    item.completionKind = com.hmx.ide.lsp.models.CompletionItemKind.METHOD
