...
import com.hmx.ide.lsp.java.rewrite.RemoveException
import com.hmx.ide.lsp.java.utils.CodeActionUtils
...
class RemoveUnusedThrowsAction : BaseJavaCodeAction() {
  ...
  override fun prepare(data: ActionData) {
    ...
    if (
      !visible ||
      !data.hasRequiredData(com.hmx.ide.lsp.models.DiagnosticItem::class.java)
    ) {
      markInvisible()
      return
    }
  ...
  override suspend fun execAction(data: ActionData): Any {
    val d = data[com.hmx.ide.lsp.models.DiagnosticItem::class.java]!!
    val compiler =
