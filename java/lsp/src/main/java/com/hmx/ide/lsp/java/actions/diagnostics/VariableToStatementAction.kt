 ...
 */
package com.hmx.ide.lsp.java.actions.diagnostics
...
import com.hmx.ide.lsp.java.rewrite.ConvertVariableToStatement
import com.hmx.ide.lsp.java.utils.CodeActionUtils.findPosition
...
class VariableToStatementAction : BaseJavaCodeAction() {
  ...
  override fun prepare(data: ActionData) {
    ...
    if (!data.hasRequiredData(com.hmx.ide.lsp.models.DiagnosticItem::class.java)) {
      markInvisible()
      return
    }

    val diagnostic = data.get(com.hmx.ide.lsp.models.DiagnosticItem::class.java)!!
  ...
  override suspend fun execAction(data: ActionData): Any {
    val diagnostic = data[com.hmx.ide.lsp.models.DiagnosticItem::class.java]!!
    val compiler =
