...
import com.hmx.ide.logsender.utils.LogReader;
import com.hmx.ide.logsender.utils.Logger;
...
public final class LogSender extends ILogSender.Stub implements ServiceConnection {
   ...
   */
  public static final String SERVICE_ACTION = "com.hmx.ide.LOG_SERVICE_ACTION";
   ...
   */
  public static final String PACKAGE_ANDROIDIDE = "com.hmx.ide";
